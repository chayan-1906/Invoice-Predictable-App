...
function ViewCorrespondence_Template1(props) {
    ...
    return (
        ...
        <Paper className={stylePaper.style}>
            ...
            <div>
                <Typography style={{top: "205px", left: "150px", width: "1300px", height: "275px", textAlign: "left", font: "normal normal normal 20px/28px Ubuntu", letterSpacing: "0.36px", opacity: "1", color: "#C0C6CA", padding: "10px", marginLeft: "20px"}}>Subject: Invoice Details - {"Account Name"} <br/><br/> Dear Sir/Madam, Greetings! <br/><br/> This is to remind you that there are one or more open invoices on your account. lease provide at your earliest convenience an update on the payment details or clarify the reason for the delay. If you have any specific issue with the invoice(s), please let us know so that we can address it to the correct Department. <br/><br/> Please find the details of the invoices below:</Typography>
                <Typography style={{top: "205px", left: "150px", width: "1300px", height: "275px", textAlign: "left", font: "normal normal normal 20px/28px Ubuntu", letterSpacing: "0.36px", opacity: "1", color: "#C0C6CA", padding: "10px", marginLeft: "20px"}}>Total Amount to be Paid: $124.00K In case you have already made a payment for the above items, please send us the details to ensure the payment is posted. Let us know if we can be of any further assistance. Looking forward to hearing from you. Kind Regards, [Sender’s First Name][Sender’s Last Name] Phone : [Sender’s contact number] Fax : [If any] Email : [Sender’s Email Address] Company Name[Sender’s Company Name]</Typography>
            </div>
...
export default ViewCorrespondence_Template1;